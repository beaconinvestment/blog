...
<?php $__env->startSection('header_styles'); ?>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo e(asset('assets/vendors/fancybox/jquery.fancybox-buttons.css')); ?>"/>
    <!-- Add Thumbnail helper (this is optional) -->
    <link rel="stylesheet" type="text/css"
          href="<?php echo e(asset('assets/vendors/fancybox/jquery.fancybox-thumbs.css')); ?>"/>
    <!--page level css end-->
<?php $__env->stopSection(); ?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-lg-2 col-md-3 col-xs-6 col-sm-3 gallery-border">
                                                <a class="fancybox-effects-a"
                                                   href="<?php echo e(asset('assets/img/img_holder/gal/1.jpg')); ?>"
                                                   title="Click aside to exit popup">
                                                    <img src="<?php echo e(asset('assets/img/img_holder/gal/1.jpg')); ?>"
                                    ...
                                    <div class="tab-pane gallery-padding" id="tab_2">
                                        <div class="col-md-12">
                                            <div class="col-lg-2 col-md-2 col-xs-6 col-sm-3 gallery-border">
                                                <a class="fancybox"
                                                   href="<?php echo e(asset('assets/img/img_holder/gal/2.jpg')); ?>"
                                                   data-fancybox-group="gallery" title="Image Title 1">
                                                    <img src="<?php echo e(asset('assets/img/img_holder/gal/2.jpg')); ?>"
                                                         class="img-responsive gallery-style" alt="Image">
                                                </a>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-xs-6 col-sm-3 gallery-border">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-lg-2 col-md-2 col-xs-6 col-sm-3 gallery-border">
                                                <a class="fancybox-buttons" data-fancybox-group="button"
                                                   href="<?php echo e(asset('assets/img/img_holder/gal/3.jpg')); ?>">
                                                    <img src="<?php echo e(asset('assets/img/img_holder/gal/3.jpg')); ?>"
                                                         class="img-responsive gallery-style" alt="Image">
                                                </a>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-xs-6 col-sm-3 gallery-border">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-lg-2 col-md-2 col-xs-6 col-sm-3 gallery-border">
                                                <a class="fancybox-thumbs" data-fancybox-group="thumb"
                                                   href="<?php echo e(asset('assets/img/img_holder/gal/4.jpg')); ?>">
                                                    <img src="<?php echo e(asset('assets/img/img_holder/gal/4.jpg')); ?>"
                                                         class="img-responsive gallery-style" alt="Image">
                                                </a>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-xs-6 col-sm-3 gallery-border">
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script type="text/javascript"
            src="<?php echo e(asset('assets/vendors/fancybox/jquery.mousewheel.pack.js')); ?>"></script>
    <script type="text/javascript"
            src="<?php echo e(asset('assets/vendors/fancybox/jquery.fancybox.pack.js')); ?>"></script>
    <script type="text/javascript"
            src="<?php echo e(asset('assets/vendors/fancybox/jquery.fancybox-buttons.js')); ?>"></script>
    <script type="text/javascript"
            src="<?php echo e(asset('assets/vendors/fancybox/jquery.fancybox-thumbs.js')); ?>"></script>
    <!-- Add Media helper (this is optional) -->
    <script type="text/javascript"
            src="<?php echo e(asset('assets/vendors/fancybox/jquery.fancybox-media.js')); ?>"></script>
