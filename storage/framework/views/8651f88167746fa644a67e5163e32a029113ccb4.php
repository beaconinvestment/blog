...
<?php $__env->startSection('header_styles'); ?>    
	...
	<link href="<?php echo e(asset('assets/css/pages/jqvmap.css')); ?>" media="screen" rel="stylesheet" type="text/css" />
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/vendors/jqvmap/js/jquery.vmap.js')); ?>"  type="text/javascript"></script>
    <script src="<?php echo e(asset('assets/vendors/jqvmap/js/jquery.vmap.world.js')); ?>"  type="text/javascript"></script>
    <script src="<?php echo e(asset('assets/vendors/jqvmap/js/jquery.vmap.usa.js')); ?>"  type="text/javascript"></script>
    <script src="<?php echo e(asset('assets/vendors/jqvmap/js/jquery.vmap.europe.js')); ?>"  type="text/javascript"></script>
    <script src="<?php echo e(asset('assets/vendors/jqvmap/js/jquery.vmap.germany.js')); ?>"  type="text/javascript"></script>
    <script src="<?php echo e(asset('assets/vendors/jqvmap/js/jquery.vmap.russia.js')); ?>"  type="text/javascript"></script>
    <script src="<?php echo e(asset('assets/vendors/jqvmap/js/jquery.vmap.sampledata.js')); ?>" ></script>
