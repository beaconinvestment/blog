                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="compose row">
                            ...
                            <div class="col-xs-12">
                                <a href="<?php echo e(URL::to('admin/inbox')); ?>" class="btn btn-sm btn-primary btn_margin_top">
                                    <span class="livicon" data-n="external-link" data-s="12" data-c="white"
                                          data-hc="white"></span>
                                    Send
                                </a>

                                <a href="<?php echo e(URL::to('admin/draft')); ?>" class="btn btn-sm btn-success btn_margin_top">
                                    <span class="livicon" data-n="briefcase" data-s="12" data-c="white"
                                          data-hc="white"></span>
                                    Draft
                                </a>

                                <a href="<?php echo e(URL::to('admin/inbox')); ?>" class="btn btn-sm btn-warning btn_margin_top">
